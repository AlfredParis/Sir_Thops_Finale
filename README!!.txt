Hi! Im alfred D. Paris if tutulong ka HAHAHA thank you kinda busy kaya di ako makafocus
Setup:
new terminal using GitBash
source virt/Scripts/activate
pip install pymysql
make database in xampp name:4-a
...
4. then test (Note: if mag pupush kayo sa new repository nalang if di mo alam mag push pa pm nalang ako)